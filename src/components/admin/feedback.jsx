    ...
    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl shadow-lg p-8">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow p-6 border-l-4 border-blue-500">
          ...
          <h3 className="text-4xl font-bold text-blue-600">{feedbacks.length}</h3>
        </div>
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {filteredFeedbacks.map(feedback => (
            <div key={feedback._id} className="bg-white rounded-lg shadow p-6 border-l-4 border-indigo-500 hover:shadow-lg transition">
              ...
              {feedback.branch && feedback.branch !== "All Branches" && (
                <div className="mb-3 inline-block bg-indigo-100 text-indigo-700 px-3 py-1 rounded-full text-sm font-semibold">
                  📍 {feedback.branch}
                </div>
              )}
